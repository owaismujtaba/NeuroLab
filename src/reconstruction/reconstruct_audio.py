...
# File taken from Neurointerfacing Lab
...
if __name__ == "__main__":
    ...
    #(sr,wf) = wavefile.read('/home/owaismujtaba/projects/NeuroLab/Data/P01_audio.npy')
    #wf = wf[10*sr:20*sr]
    ...
    import time
    t=time.time()
    spectrogram = np.load('/home/owaismujtaba/projects/NeuroLab/Predictions/01/LR/Actual_Fold_0.npy')
    data = reconstructWavFromSpectrogram(spectrogram,1024)
    print(time.time()-t)
